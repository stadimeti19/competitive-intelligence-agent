...
import base64
from contextlib import redirect_stdout # Needed for capturing print outputs
...
os.makedirs(coding_work_dir, exist_ok=True) # Create if it doesn't exist
...
# --- Main Function to Run AutoGen Chat ---
